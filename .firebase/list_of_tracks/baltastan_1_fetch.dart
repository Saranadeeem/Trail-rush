...
class Baltisitan1Fetch extends StatelessWidget {
  final bool isDesktop;
  const Baltisitan1Fetch({super.key, required this.isDesktop});
  ...
  Widget build(BuildContext context) {
    ...
    ListOfTracksModel.collection()
        .where('location', isEqualTo: "BAlTISTAN1") // Corrected field value
        .snapshots();
