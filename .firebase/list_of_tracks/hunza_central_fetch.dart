...
class HunzaCentralFetch extends StatelessWidget {
  final bool isDesktop;
  const HunzaCentralFetch({super.key, required this.isDesktop});
  ...
  Widget build(BuildContext context) {
    ...
    ListOfTracksModel.collection()
        .where('location', isEqualTo: "HUNZA CENTRAL") // Corrected field value
        .snapshots();
