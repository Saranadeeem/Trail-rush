...
class GhizerWestOfGilgitFetch extends StatelessWidget {
  final bool isDesktop;
  const GhizerWestOfGilgitFetch({super.key, required this.isDesktop});
  ...
  Widget build(BuildContext context) {
    ...
    ListOfTracksModel.collection()
        .where('location', isEqualTo: "GHIZER-WEST OF GILGIT") // Corrected field value
        .snapshots();
