...
class Baltisitan2Fetch extends StatelessWidget {
  final bool isDesktop;
  const Baltisitan2Fetch({super.key, required this.isDesktop});
  ...
  Widget build(BuildContext context) {
    ...
    ListOfTracksModel.collection()
        .where('location', isEqualTo: "BAlTISTAN2") // Corrected field value
        .snapshots();
