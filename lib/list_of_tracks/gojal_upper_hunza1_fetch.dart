...
class GojalUpperHunza1Fetch extends StatelessWidget {
  final bool isDesktop;
  const GojalUpperHunza1Fetch({super.key, required this.isDesktop});
  ...
  Widget build(BuildContext context) {
    ...
    ListOfTracksModel.collection()
        .where('location', isEqualTo: "GOJAL-UPPER HUNZA1") // Corrected field value
        .snapshots();
