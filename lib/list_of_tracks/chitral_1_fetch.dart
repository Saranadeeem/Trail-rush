...
class Chitral1Fetch extends StatelessWidget {
  final bool isDesktop;
  const Chitral1Fetch({super.key, required this.isDesktop});
  ...
  Widget build(BuildContext context) {
    ...
    ListOfTracksModel.collection()
        .where('location', isEqualTo: "CHITRAL1") // Corrected field value
        .snapshots();
