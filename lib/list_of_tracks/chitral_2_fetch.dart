...
class Chitral2Fetch extends StatelessWidget {
  final bool isDesktop;
  const Chitral2Fetch({super.key, required this.isDesktop});
  ...
  Widget build(BuildContext context) {
    ...
    ListOfTracksModel.collection()
        .where('location', isEqualTo: "CHITRAL2") // Corrected field value
        .snapshots();
