...
class GilgitDiamerFetch extends StatelessWidget {
  final bool isDesktop;
  const GilgitDiamerFetch({super.key, required this.isDesktop});
  ...
  Widget build(BuildContext context) {
    ...
    ListOfTracksModel.collection()
        .where('location', isEqualTo: "GILGITANDDIAMER") // Corrected field value
        .snapshots();
