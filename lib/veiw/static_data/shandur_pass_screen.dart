...
class ShandurPassScreen extends StatelessWidget {

  const ShandurPassScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final ShandurPassDetailModel shandurPassData = ShandurPassDetailModel(
      name: 'Shandur Pass',
              ...
              child: Column(
                ...
                children: [
                        ...
                        children: [
                          Align(
                            ...
                            child: Column(
                              ...
                              children: [
                                CustomText(
                                  text: shandurPassData.name,
                                  fontSize: isDesktop?60:24.75,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white,
                                ),
                                CustomText(
                                  text: shandurPassData.months,
                          ...
                          Positioned(
                            ...
                            bottom: 0,
                            child: Row(
                              children: _buildDetailInfoRow(shandurPassData,isLittleMobile || isMobile,isDesktop
                                  ? 24
                                  : isMobile? 9:isTablet
                                  ? 18
                                  : isLittleMobile
                  ...
                  _buildSection(
                    ...
                    isTablet: isTablet,
                    title: 'Overview',
                    content: shandurPassData.overview,
                  ...
                  _buildSection(
                    ...
                    isTablet: isTablet,
                    title: 'Descriptions',
                    content: shandurPassData.description,
                    isMobile: isLittleMobile || isMobile,
                    screenWidth: screenWidth,
                  ),
                  ...
                  _buildSection(
                    ...
                    isTablet: isTablet,
                    title: 'History',
                    content: shandurPassData.history,
                    isMobile: isLittleMobile || isMobile,
                    screenWidth: screenWidth,
                  ),
                  ...
                  GridView.custom(
                    ...
                    childrenDelegate: SliverChildBuilderDelegate(
                        ...
                        return ClipRRect(
                          ...
                          child: Image.asset(
                            shandurPassData.imageUrls[index],
                            fit: BoxFit.cover,
                          ),
                        );
                      },
                      childCount: shandurPassData.imageUrls.length, // Show all images
                    ),
                  ),
                  ...
                  isDesktop
                    ...
                    children: [
                      CustomContainer(
                        ...
                        child: CustomPasses(
                          name: "Babusar Pass",
                          image: AssetImage('assets/images/reduced.jpg'),
                          elevation: '4,173 m',
                          duration: 'Any Length',
                          season: 'June-Nov',
                          isOpen: false,
  ...
  List<Widget> _buildDetailInfoRow(shandurPassData ,bool isMobile,fontSize) {
    return [
      _buildDetailInfoItem('Difficulty', shandurPassData?.difficulty, isMobile,fontSize),
      SizedBox(height: 5),
      _buildVerticalDivider(),
      SizedBox(height: 5),
      _buildDetailInfoItem('Elevation', shandurPassData?.elevation, isMobile,fontSize),
      SizedBox(height: 5),
      _buildVerticalDivider(),
      const SizedBox(height: 5),
      _buildDetailInfoItem('Duration', shandurPassData?.duration, isMobile,fontSize),
    ];
  }
